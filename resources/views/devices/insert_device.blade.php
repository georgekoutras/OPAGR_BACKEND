                            ...
                            <form method="post" action="{{route('device.store')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                           placeholder="e.g. DE1258A">
                                </div>

                                <div class="form-group">
                                    <label for="connectivity">Connectivity</label>
                                    <select class="form-control" id="cultivation_type" name="connectivity">
                                        <option>RockBlock</option>
                                        <option>GPRS</option>
                                ...
                                <hr>
                                <small>analoga me to ti epilegei na vgazei ta katallila inputs gia na siblirwsei</small>
                                ...
                                <div class="form-group">
                                    <label for="gprs_id">GPRS ID</label>
                                    <input type="text" class="form-control" id="gprs_id" name="gprs_id">
                                </div>
                                ...
                                <button type="submit" class="btn btn-dark">Insert the device</button>
                            </form>
